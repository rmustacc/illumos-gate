...
extern uint32_t i2c_device_disc_naddrs(const i2c_dev_disc_t *);
extern const i2c_addr_t *i2c_device_disc_addr(const i2c_dev_disc_t *, uint32_t);
...
extern bool i2c_io_req_init_by_device(i2c_dev_t *, i2c_io_req_t **);
...
extern bool smbus_io_req_init_by_device(i2c_dev_t *, smbus_io_req_t  **);
